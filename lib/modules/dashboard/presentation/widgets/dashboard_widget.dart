...
onLoadStop: (controller, url) {
  ...
  // --- THÊM DÒNG NÀY VÀO ---
  controller.injectCSSCode(source: ".tb-powered-by-footer { display: none !important; } div[class*='powered-by'] { display: none !important; }");
},
...
Future<void> _onWebViewCreated(
    ...
    // Tiêm CSS để ẩn dòng chữ Powered By và Footer
    webViewController.injectCSSCode(source: """
      .tb-powered-by-footer { display: none !important; }
      .footer { display: none !important; }
      div[class*="powered-by"] { display: none !important; }
    """);
